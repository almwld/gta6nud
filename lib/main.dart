  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: bodyManager),
      ],
      child: const GTA6App(),
    ),
  );
...
class GTA6App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(brightness: Brightness.dark, primaryColor: const Color(0xFFFF2A6D), scaffoldBackgroundColor: const Color(0xFF050508)),
